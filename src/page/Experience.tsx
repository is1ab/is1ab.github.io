    ...
    return (
        <div className="experience">
                ...
                <ul>
                    <li>國立臺北科技大學 資訊工程系 助理教授（2022/8 - pres.）
                        <ul>
                            ...
                            <li>計算機與網路發展指導委員（2022/8 - pres.）</li>
                            <li>院務會議 候補委員（2023/8 - pres.）</li>
            ...
            <>
                ...
                <ul>
                    <li>強化醫療生態系數位韌性技術研發及評測計畫（資安院計畫 - 協同主持人，<Passed/>）</li>
                    <li>建構威脅情資知識圖及攻擊事件自動化辨識技術（資安院計畫，執行中）</li>
                    <li>具網路韌性且可信賴之低軌衛星通訊系統：互聯互通認證、軟體安全、物聯網永續性、保有隱私、假資訊偵測（國科會計畫共同主持人，<Progressing/>）</li>
                    <li>整合多項新穎技術於網路防禦系統以抵抗網路威脅之研究（國科會計畫，<Progressing/>）</li>
            ...
            <>
                ...
                <ul>
                    <li>榮獲112學年度第1學期 國立臺北科技大學 - （大一導生）保管教室整潔評比優良 113.02.16</li>
