export function RuleInternal() {
  const principles = [
    ...
    "學位為重，再追求附加成果。競賽、專案、實習與社團都不能取代學位與碩士論文進度",
  ];
  ...
  const baseRequirements = [
    ...
    "每週需固定提交進度摘要，進度延遲時，須主動說明原因與補救計畫",
    "每月至少一次研究、技術或專案分享",
    "每學期需承擔一項公共任務",
    "所有成果需留下可交接之文件或紀錄",
    "必須完成碩士論文並通過口試",
  ...
  const timeline = [
    {
      ...
      items: [
        ...
        "參與共通核心訓練",
        "了解實驗室制度與畢業要求",
        "參與 Group Meeting（必要時可線上）",
        "繳交指導教授同意單前，正式選定 Track",
      ],
    },
    {
      phase: "碩一上",
          ...
          <div className="position-relative">
            <div className="row g-4 align-items-center">
              <div className="col-12 col-xl-8">
                ...
                >
                  我們的目標不僅是培養會讀寫論文的人，也不僅是培養會打比賽的人，而是希望兩年內培養出一位完成碩士學位，並具備專業資歷的畢業生，成為資安職涯的優秀前行者。
                </p>
              ...
              <div style={{ ...sectionWrapStyle, height: "100%" }}>
                <div className="mb-4">
                  ...
                  <p style={sectionDescStyle}>
                    這一段是整份手冊的底層設計邏輯。它不是活動規範而已，而是整個實驗室在資源配置、角色期待與訓練排序上的基本立場。
                  </p>
                </div>
