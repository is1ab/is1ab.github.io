...
export const RyanMemberPage = () => {
    ...
    const bio = (
        <div className="d-flex flex-column gap-3">
            ...
            <p>他曾參與多項大型專案，包括與國家資通安全研究院(NICS)、日本情報通信研究院(NICT)、國家衛生研究院(NHRI)及多家大型醫院的合作，並協助指導超過十五位碩士生投入研究。</p>
            <p>此外，他曾擔任 AIS3 情資與分析講師，以及師大資工碩士班高等資安攻防課程講師。目前，他獲國家科學及技術委員會補助，於澳洲蒙納許大學（ranked #37 in QS World University Rankings 2025）軟體系統與網路安全系進行訪問研究。</p>
