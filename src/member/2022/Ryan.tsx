...
export const RyanMemberPage = () => {
    ...
    const bio = (
        <div className="d-flex flex-column gap-3">
          <p>陳勝舢現為國立臺北科技大學資訊工程系博士候選人，並擔任奧義智慧科技 (CyCraft) 的實習資安研究員。</p>
          <p>他的研究專注於語言模型、網路威脅情資分析、醫療大數據，以及 AI 技術在資訊安全領域的應用。</p>
          <p>他曾參與多項大型專案，包括與國家資通安全研究院、日本情報通信研究院、國家衛生研究院及多家大型醫院的合作，並帶領超過十五位碩士生參與研究。</p>
          <p>此外，他曾擔任 AIS3 情資與分析講師，以及師大資工碩士班高等資安攻防課程講師。目前，他獲國家科學及技術委員會補助，於澳洲蒙納許大學軟體系統與網路安全系進行訪問研究。</p>
          <p>更多資訊（著作、專案）請參閱：<a href="https://sectools.tw/about/sean">sectools.tw/about/sean</a></p>
        </div>
      );
    ...
    return (
        <Sample
            ...
            avatar={Uriah}
            institutes={["Ph.D. Candidate, CSIE, NTUT | CyberSecurity Researcher @CyCraft"]}
            bio={bio}
